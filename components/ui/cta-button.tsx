...
const CTAButton = ({ className }: { className?: string }) => {
    return (
        <MotionButton
            ...
            <Link href="/signin" className={cn("relative flex text-sm font-medium rounded-full h-10 p-1 ps-4 pe-12 group transition-all duration-500 hover:ps-12 hover:pe-4 w-fit overflow-hidden", className)}>
